...
static void MoveFromReturnRegister(Location trg,
  ...
  if (DataType::IsIntegralType(type) || type == DataType::Type::kReference) {
    ...
    if (trg_reg != A0) {
      __ Move(trg_reg, A0);  // __ Move(A0, trg_reg);
    }
  } else {
    FpuRegister trg_reg = trg.AsFpuRegister<FpuRegister>();
    if (trg_reg != FA0) {
      if (type == DataType::Type::kFloat32) {
        __ MovS(trg_reg, FA0);  // __ MovS(FA0, trg_reg);
      } else {
        __ MovD(trg_reg, FA0);  // __ MovD(FA0, trg_reg);
      }
    }
  }
}
...
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendObject);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendString);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendCharSequence);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendCharArray);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendBoolean);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendChar);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendInt);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendLong);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendFloat);
UNIMPLEMENTED_INTRINSIC(RISCV64, StringBuilderAppendDouble);
...
UNIMPLEMENTED_INTRINSIC(RISCV64, FP16ToFloat)
UNIMPLEMENTED_INTRINSIC(RISCV64, FP16ToHalf)
UNIMPLEMENTED_INTRINSIC(RISCV64, FP16Greater)
UNIMPLEMENTED_INTRINSIC(RISCV64, FP16GreaterEquals)
...
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleCompareAndSet)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGet)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAcquire)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndAdd)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndAddAcquire)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndAddRelease)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseAnd)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseAndAcquire)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseAndRelease)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseOr)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseOrAcquire)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseOrRelease)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseXor)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseXorAcquire)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndBitwiseXorRelease)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndSet)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndSetAcquire)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetAndSetRelease)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetOpaque)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleGetVolatile)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleSet)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleSetOpaque)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleSetRelease)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleSetVolatile)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleWeakCompareAndSet)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleWeakCompareAndSetAcquire)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleWeakCompareAndSetPlain)
UNIMPLEMENTED_INTRINSIC(RISCV64, VarHandleWeakCompareAndSetRelease)
