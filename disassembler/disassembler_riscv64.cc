...
// format:COMP_OPCODE_[instruction type][funct size]
// instruction type: use F to distinguish with R which oprand has RoundingMode field
#define COMP_OPCODE_R(opcode, funct3, funct7)   \
    (static_cast<uint32_t>(funct7) << 25 | static_cast<uint32_t>(funct3) << 12 | opcode)
#define COMP_OPCODE_F(opcode, funct7)     (static_cast<uint32_t>(funct7) << 25 | opcode)
#define COMP_OPCODE_R6(opcode, funct3, funct6)   \
    (static_cast<uint32_t>(funct6) << 26 | static_cast<uint32_t>(funct3) << 12 | opcode)
#define COMP_OPCODE_R5(opcode, funct3, funct5)   \
    (static_cast<uint32_t>(funct5) << 27 | static_cast<uint32_t>(funct3) << 12 | opcode)
#define COMP_OPCODE_F4(opcode, funct2)    (static_cast<uint32_t>(funct2) << 25 | opcode)
...
static const uint32_t kFTypeMask = (uint32_t)0x7f << 25 | 0x7f;
static const uint32_t kR6TypeMask = (uint32_t)0x3f << 26 | (uint32_t)0x7 << 12 | 0x7f;
static const uint32_t kR5TypeMask = (uint32_t)0x1f << 27 | (uint32_t)0x7 << 12 | 0x7f;
static const uint32_t kF4TypeMask = (uint32_t)0x03 << 25 | 0x7f;
...
InstructionInfo gInstructions[] = {
  ...
  {kR6TypeMask, COMP_OPCODE_R6(0x13,  0x1,  0x0), "slli", "Rrri"},  // RV64I-R
  {kR6TypeMask, COMP_OPCODE_R6(0x13,  0x5,  0x0), "srli", "Rrri"},  // RV64I-R
  {kR6TypeMask, COMP_OPCODE_R6(0x13,  0x5, 0x10), "srai", "Rrri"},  // RV64I-R
  ...
  {kF4TypeMask, COMP_OPCODE_F4(0x43,  0x0), "fmadd.s", "Rffff"},  // RV32F-R
  {kF4TypeMask, COMP_OPCODE_F4(0x47,  0x0), "fmsub.s", "Rffff"},
  {kF4TypeMask, COMP_OPCODE_F4(0x4b,  0x0), "fnmsub.s", "Rffff"},
  {kF4TypeMask, COMP_OPCODE_F4(0x4f,  0x0), "fnmadd.s", "Rffff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0x0), "fadd.s", "Rfff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0x4), "fsub.s", "Rfff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0x8), "fmul.s", "Rfff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0xc), "fdiv.s", "Rfff"},
  ...
  {kF4TypeMask, COMP_OPCODE_F4(0x43,  0x1), "fmadd.d", "Rffff"},  // RV32D-R
  {kF4TypeMask, COMP_OPCODE_F4(0x47,  0x1), "fmsub.d", "Rffff"},
  {kF4TypeMask, COMP_OPCODE_F4(0x4b,  0x1), "fnmsub.d", "Rffff"},
  {kF4TypeMask, COMP_OPCODE_F4(0x4f,  0x1), "fnmadd.d", "Rffff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0x1), "fadd.d", "Rfff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0x5), "fsub.d", "Rfff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0x9), "fmul.d", "Rfff"},
  {kFTypeMask, COMP_OPCODE_F(0x53, 0xd), "fdiv.d", "Rfff"},
...
std::string DisassemblerRiscv64::DumpInstruction(uint32_t encoding) {
  ...
  std::string ass_instructon = StringPrintf("op=0x%x", op);
